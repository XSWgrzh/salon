...
import com.salon.common.core.utils.DateUtil;
...
public class GlobalJsonJacksonCodec extends JsonJacksonCodec {
    ...
    private static ObjectMapper objectMapper() {
        ...
        DateTimeFormatter dateTimeFormatter =
                DateUtil.getDateTimeFormatter(DateUtil.YYYY_ROD_MM_ROD_DD_SPACE_HH_RISK_HH_RISK_SS);
        // Long类型转String类型
